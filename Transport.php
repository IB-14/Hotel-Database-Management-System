        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <h3><span style="margin-left: 4em;">Transport</span></h3>
                    ...
                    <div class="wrap-table100">
                        ...
                        <table>
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT p.room_no, p.room_type from provides p join services s on s.ROOM_TYPE = p.room_type where s.Transport='No'";
                                    ...
                                    if($rowcount > 0){
                                        ...
                                        echo "</table>";
                                            ...
                                            if(isset($_POST['update']) && intval($_POST['update']))
                                            {
                                                ...
                                                $query = "UPDATE bills SET bill= bill + 50 WHERE room_no = $amtr;";
                                                //echo $rowroomtype[0];
                                                $query .= "UPDATE SERVICES SET transport='Yes' WHERE room_type= (SELECT room_type from room where room_no=$amtr);";  
